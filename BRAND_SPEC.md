...
│   │   ├── ev-wordmark-300.png
│   │   └── logo-dark-300.png
│   └── qr/                        ← generated by generate_qr.py (4 variants: cream/transparent × logo/no-logo)
│       ├── qr-hi.png
│       ├── qr-hi-plain.png
│       ├── qr-hi-transparent.png
│       └── qr-hi-transparent-plain.png
├── templates/
...
| `assets/qr/qr-hi.png` | 860×860 | URL: /hi/ — cream bg + EV logo (canonical) | `generate_qr.py` | Active |
| `assets/qr/qr-hi-plain.png` | 860×860 | URL: /hi/ — cream bg, no logo | `generate_qr.py` | Active |
| `assets/qr/qr-hi-transparent.png` | 860×860 | URL: /hi/ — transparent bg + EV logo | `generate_qr.py` | Active |
| `assets/qr/qr-hi-transparent-plain.png` | 860×860 | URL: /hi/ — transparent bg, no logo | `generate_qr.py` | Active |
